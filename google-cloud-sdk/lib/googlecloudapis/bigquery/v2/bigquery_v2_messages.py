...
class JobConfigurationLoad(messages.Message):
  ...
  Fields:
    ...
    maxBadRecords: [Optional] The maximum number of bad records that BigQuery
      ...
      valid.
    projectionFields: [Experimental] Names(case-sensitive) of properties to
      keep when importing data. If this is populated, only the specified
      properties will be imported for each entity. Currently, this is only
      supported for DATASTORE_BACKUP imports and only top level properties are
      supported. If any specified property is not found in the Datastore
      'Kind' being imported, that is an error. Note: This feature is
