...
The Google Cloud Test API allows developers to run automated tests for their
...
class TestExecution(messages.Message):
  ...
  matrixId = messages.StringField(4)
  projectId = messages.StringField(5)
  resultStorage = messages.MessageField('ResultStorage', 6)
  state = messages.EnumField('StateValueValuesEnum', 7)
  testDetails = messages.MessageField('TestDetails', 8)
  testSpecification = messages.MessageField('TestSpecification', 9)
  timestamp = messages.StringField(10)
...
class TestMatrix(messages.Message):
  ...
  testExecutions = messages.MessageField('TestExecution', 5, repeated=True)
  testMatrixId = messages.StringField(6)
